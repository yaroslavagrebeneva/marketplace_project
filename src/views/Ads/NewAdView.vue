    ...
    createAd() {
      if (this.$refs.form.validate()) {
        const ad = {
          ...
          promo: this.promo,
          src: "https://cdn.vuetifyjs.com/images/cards/cooking.png" // Статическая картинка
        };
        this.$store.dispatch("createAd", ad); // Отправка action
